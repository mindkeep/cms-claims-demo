...
def file_names_for_sample(sample_n: int) -> list[str]:
    ...
    n = sample_n
    return [
        f"DE1_0_2008_Beneficiary_Summary_File_Sample_{n}.zip",
        f"DE1_0_2009_Beneficiary_Summary_File_Sample_{n}.zip",
        f"DE1_0_2010_Beneficiary_Summary_File_Sample_{n}.zip",
        f"DE1_0_2008_to_2010_Inpatient_Claims_Sample_{n}.zip",
        f"DE1_0_2008_to_2010_Outpatient_Claims_Sample_{n}.zip",
        f"DE1_0_2008_to_2010_Carrier_Claims_Sample_{n}A.zip",
        f"DE1_0_2008_to_2010_Carrier_Claims_Sample_{n}B.zip",
        f"DE1_0_2008_to_2010_Prescription_Drug_Events_Sample_{n}.zip",
    ]
